...
* <a href="https://sc.5ht.co"><b>sc</b></a> — Sokhatsky Commander — сучасний двохпанельний файловий менеджер у традиції Джона Соча (Norton Commander).
* <a href="https://be.5ht.co"><b>be</b></a> — Binary Editor — InfoSec hex-редактор з повноцінним дизасемблером. 
* <a href="https://tv.5ht.co"><b>tv</b></a> — Terminal Vision — простий текстовий редактор у стилі IBM CUA, режим перегляду/редагування, мінімальне меню збереження.
...
* <a href="https://skynetrt.github.io/rt/">rt</b></a> Skynet Run-Time — мінімалістична POSIX-сумісна RTOS для вбудованих систем. 
