...
<p>Є цілий клас файлових менеджеріву, серед яких Norton Commander, Volkov Commander (Всеволода Волкова), Demos Commander (Серія Вакуленко),
   Dos Navigator, Total Commander, FAR Manager. Такі програми зручно використовати для навігації по файловій системі
   і впорядкуванню бібліотек. Фактично це воно (!), але:</p>
