...
* <a href="https://sc.5ht.co">sc</a> — Sokhatsky Commander — сучасний двохпанельний файловий менеджер у традиції Norton/Total Commander, з вбудованими редакторами TV та BE, історією команд, коректною передачею керування зовнішнім програмам. Розмір бінарника ~35 KB, 1K LOC, 5 файлів.
* <a href="https://be.5ht.co">be</a> — Binary Editor — InfoSec hex-редактор з повноцінним дизасемблером. Підтримка HEX-режиму змінної довжини, ASM-режиму, 16/32/64/128-бітних архітектур, маркування змін, анотацій регіонів, патчів, пошуку, редагування дискових секторів (LBA), контейнерів ELF/Mach-O/PE. Дизасемблери: EM64T, RISC-V, AArch64 (перша лінія); M68K, PowerPC, MIPS, SuperH (друга); PDP-11, Z80, 6502, HC08/HC11 (третя); CLR, JVM, BEAM, EFI Byte Code (четверта). vi-подібна навігація.
* <a href="https://tv.5ht.co">tv</a> — Terminal Vision — простий текстовий редактор у стилі IBM CUA, режим перегляду/редагування, мінімальне меню збереження.
* <a href="https://sh.5ht.co">sh</a> — Verified Shell — перший у світі формально верифікований POSIX-сумісний шел. BNF у LR(1), вбудовані/зовнішні команди, відповідність IEEE 1003.2. Формальні моделі на OCaml (верифікація F*) та Coq (CIC/MLTT), генерація C-коду з моделей. Працює на Windows, Linux, macOS, BSD.
* <a href="https://skynetrt.github.io/rt/">rt</a> Skynet Run-Time — мінімалістична POSIX-сумісна RTOS для вбудованих систем. ANSI C99, обмежений набір апаратних платформ, простий make-білд. Розмір архіву джерел ≤ 2.88 MB (~200K LOC).
* <a href="https://skynetrt.github.io/skynet/">skynet</a> Skynet OS — мінімалістична імплементація Skynet32 drone swarm coordination протоколу.
